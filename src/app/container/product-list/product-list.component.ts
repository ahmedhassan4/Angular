...
@Component({
  ...
  standalone: true,
  imports: [NgStyle, ProductComponent, FilterComponent],
...
export class ProductListComponent {
  ...
  totalProductInStock:number = this.products.filter(el => el.is_in_inventory).length
  totalProductOutOfStock:number = this.products.filter(el => !el.is_in_inventory).length

  selectedFilterRadioButton:string = 'all'
  onFilterChagne(value:string){
